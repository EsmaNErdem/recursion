...
describe("realSize", function () {
	it('should return number of integers in tested array', function () {
    expect(realSize([])).toEqual(0)
    expect(realSize([[]])).toEqual(0)
    expect(realSize([1, [1]])).toEqual(2)
    expect(realSize([1, [], 2, [], 3, []])).toEqual(3)
    expect(realSize([0, [1, [5, [4, 3], 1], 1]])).toEqual(7)
